...
export function resolveTenant(
  {
    ...
    default_tenant
  }: { request: any, username: string, roles: string[] | undefined, availabeTenants: any, config: SecurityPluginConfigType, cookie: SecuritySessionCookie, multitenancy_enabled: boolean, private_tenant_enabled: boolean | undefined, default_tenant: string | undefined },
): string | undefined {
  ...
  } else if (default_tenant  && multitenancy_enabled) {
...
function resolve(
  ...
  multitenancy_enabled: boolean | undefined,
